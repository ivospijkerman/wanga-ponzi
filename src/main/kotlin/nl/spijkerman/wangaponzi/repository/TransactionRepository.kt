package nl.spijkerman.wangaponzi.repository
...
private const val RANGE = "transactions!A2:D"
...
class TransactionRepository {
    ...
    private var lastAccess = Long.MIN_VALUE
    private lateinit var cache: List<List<Any>>
    ...
    private fun getCredentials(HTTP_TRANSPORT: NetHttpTransport): Credential? {
        // Load client secrets.
        val stream: InputStream = javaClass.getResourceAsStream(CREDENTIALS_FILE_PATH)
    ...
    fun getAll(): List<List<Any>> {
        if (lastAccess + TIMEOUT < currentTimeMillis()) {
